function ongr_throttle(t, e, i) {
    e || (e = 250);
    var s, n;
    return function () {
        var o = i || this, r = +new Date, a = arguments;
        s && s + e > r ? (clearTimeout(n), n = setTimeout(function () {
            s = r, t.apply(o, a)
        }, e)) : (s = r, t.apply(o, a))
    }
}
function ongr_match_height() {
    var t;
    $(".ongr-match-height").each(function () {
        var e = $(this).attr("data-heighttype"), i = $(this).attr("data-matchwidth");
        ("undefined" == typeof e || 0 == e) && (e = "outer"), i = "undefined" == typeof i || 0 == i ? 0 : parseInt(i), 0 == i || i > 0 && i < window.innerWidth ? (t = 0, $(this).find(".match-height").each(function () {
            $(this).css("height", "auto");
            var i;
            i = "outer" == e ? $(this).outerHeight(!0) : $(this).innerHeight(), t = Math.max(i, t)
        }), $(this).find(".match-height").css("height", t)) : $(this).find(".match-height").each(function () {
            $(this).css("height", "")
        })
    })
}
function ongr_nav_highlight() {
    for (section in ongr_sections)ongr_sections[section] >= ongr_scrolled_top && ongr_sections[section] < ongr_scrolled_top + .6 * ongr_window_height && ($("#sticky-pageheader li[data-section], #pageheader li[data-section]").removeClass("active"), $('#sticky-pageheader li[data-section="' + section + '"], #pageheader li[data-section="' + section + '"]').addClass("active"), "implementation" == section && $(".ongr-timereduction").find(".timeline-max").addClass("active"))
}
function ongr_scroll(t) {
    var e;
    e = t > ongr_scrolled_top ? t - ongr_scrolled_top : Math.abs(ongr_scrolled_top - t);
    var i = 1e3 * Math.min(.4 + e / 2e3, 1.2);
    $("html, body").animate({scrollTop: t}, i)
}
function ongr_sectiondata() {
    $(".ongr-sectionlink").each(function () {
        ongr_sections[$(this).attr("name")] = $(this).offset().top
    })
}
function ongr_sticky_nav() {
    ongr_scrolled_top > ongr_sticky_nav_threshold * ongr_window_height && !$("#sticky-pageheader").hasClass("pageheader-visible") ? $("#sticky-pageheader").addClass("pageheader-visible") : ongr_sticky_nav_threshold * ongr_window_height > ongr_scrolled_top && $("#sticky-pageheader").removeClass("pageheader-visible")
}
!function (t, e, i, s) {
    function n(e, i) {
    ...
    u = {
        ...
        updatedX: 0,
        targetEl: null
    }, p = {isTouch: !1, isScrolling: !1, isSwiping: !1, direction: !1, inMotion: !1}, g = {
        _onDragStart: null,
        _onDragMove: null,
        _onDragEnd: null,
        _transitionEnd: null,
    ...
    var n = function (e) {
        this.core = e, this.core.options = t.extend({}, n.Defaults, this.core.options), this.swapping = !0, this.previous = s, this.next = s,
            this.handlers = {
    ...
    var e = navigator.userAgent.indexOf("Windows Phone") >= 0, i = navigator.userAgent.indexOf("Android") > 0 && !e, s = /iP(ad|hone|od)/.test(navigator.userAgent) && !e, n = s && /OS 4_\d(_\d)?/.test(navigator.userAgent), o = s && /OS [6-7]_\d/.test(navigator.userAgent), r = navigator.userAgent.indexOf("BB10") > 0;
    t.prototype.needsClick = function (t) {
        ...
        } else if (this.needsFocus(c))return t.timeStamp - r > 100 || s && window.top !== window && "input" === a ? (this.targetElement = null, !1) : (this.focus(c), this.sendClick(c, t), s && "select" === a || (this.targetElement = null, t.preventDefault()), !1);
        return s && !n && (h = c.fastClickScrollParent, h && h.fastClickLastScrollTop !== h.scrollTop) ? !0 : (this.needsClick(c) || (t.preventDefault(), this.sendClick(c, t)), !1)
    ...
    "use strict";
    function e(e) {
        return o = this, o.elems = {}, o.serial = 1, o.blocked = !1, o.config = s(o.defaults, e), o.isMobile() && !o.config.mobile || !o.isSupported() ? void o.destroy() : (o.config.viewport == t.document.documentElement ? (t.addEventListener("scroll", n, !1), t.addEventListener("resize", n, !1)) : o.config.viewport.addEventListener("scroll", n, !1), void o.init(!0))
    }
    ...
    return e.prototype = {
        defaults: {
            ...
            var e, i, s;
            s = Array.prototype.slice.call(o.config.viewport.querySelectorAll("[data-sr]")), s.forEach(function (t) {
                e = o.serial++, i = o.elems[e] = {domEl: t}, i.config = o.configFactory(i), i.styles = o.styleFactory(i), i.seen = !1, t.removeAttribute("data-sr"), t.setAttribute("style", i.styles.inline + i.styles.initial)
            }), o.scrolled = o.scrollY(), o.animate(t)
        }, animate: function (t) {
            var e, i, s, n;
            n = function (t) {
                var e = o.elems[t];
                setTimeout(function () {
                    e.domEl.setAttribute("style", e.styles.inline), e.config.complete(e.domEl), delete o.elems[t]
                }, e.styles.duration)
            };
            for (e in o.elems)o.elems.hasOwnProperty(e) && (i = o.elems[e], s = o.isElemInViewport(i), s && ("always" === o.config.delay || "onload" === o.config.delay && t || "once" === o.config.delay && !i.seen ? i.domEl.setAttribute("style", i.styles.inline + i.styles.target + i.styles.transition) : i.domEl.setAttribute("style", i.styles.inline + i.styles.target + i.styles.reset), i.seen = !0, i.config.reset || i.animating || (i.animating = !0, n(e))), !s && i.config.reset && i.domEl.setAttribute("style", i.styles.inline + i.styles.initial + i.styles.reset));
            o.blocked = !1
        }, configFactory: function (t) {
            var e = {}, i = {}, n = t.domEl.getAttribute("data-sr").split(/[, ]+/);
            return n = o.filter(n), n.forEach(function (t, i) {
                switch (t) {
                    case"enter":
                        return void(e.enter = n[i + 1]);
                    case"wait":
                        return void(e.wait = n[i + 1]);
                    case"move":
                        return void(e.move = n[i + 1]);
                    case"ease":
                        return e.move = n[i + 1], void(e.ease = "ease");
                    case"ease-in":
                        return "up" == n[i + 1] || "down" == n[i + 1] ? (e.scale.direction = n[i + 1], e.scale.power = n[i + 2], void(e.easing = "ease-in")) : (e.move = n[i + 1], void(e.easing = "ease-in"));
                    case"ease-in-out":
                        return "up" == n[i + 1] || "down" == n[i + 1] ? (e.scale.direction = n[i + 1], e.scale.power = n[i + 2], void(e.easing = "ease-in-out")) : (e.move = n[i + 1], void(e.easing = "ease-in-out"));
                    case"ease-out":
                        return "up" == n[i + 1] || "down" == n[i + 1] ? (e.scale.direction = n[i + 1], e.scale.power = n[i + 2], void(e.easing = "ease-out")) : (e.move = n[i + 1], void(e.easing = "ease-out"));
                    case"hustle":
                        return "up" == n[i + 1] || "down" == n[i + 1] ? (e.scale.direction = n[i + 1], e.scale.power = n[i + 2], void(e.easing = "cubic-bezier( 0.6, 0.2, 0.1, 1 )")) : (e.move = n[i + 1], void(e.easing = "cubic-bezier( 0.6, 0.2, 0.1, 1 )"));
                    case"over":
                        return void(e.over = n[i + 1]);
                    case"reset":
                        return void(e.reset = "no" == n[i - 1] ? !1 : !0);
                    case"scale":
                        return e.scale = {}, "up" == n[i + 1] || "down" == n[i + 1] ? (e.scale.direction = n[i + 1], void(e.scale.power = n[i + 2])) : void(e.scale.power = n[i + 1]);
                    default:
                        return
                }
            }), i = s(i, o.config), i = s(i, e), ("top" == i.enter || "bottom" == i.enter) && (i.axis = "Y"), ("left" == i.enter || "right" == i.enter) && (i.axis = "X"), "hustle" == i.easing && (i.easing = "cubic-bezier( 0.6, 0.2, 0.1, 1 )"), ("top" == i.enter || "left" == i.enter) && (i.move = "-" + i.move), i
        }, styleFactory: function (t) {
            var e, i, s, n, o, r;
            return o = t.domEl.getAttribute("style") ? t.domEl.getAttribute("style") + "; visibility: visible; " : "visibility: visible; ", e = "-webkit-transition: -webkit-transform " + t.config.over + " " + t.config.easing + " " + t.config.wait + ", opacity " + t.config.over + " " + t.config.easing + " " + t.config.wait + "; transition: transform " + t.config.over + " " + t.config.easing + " " + t.config.wait + ", opacity " + t.config.over + " " + t.config.easing + " " + t.config.wait + "; -webkit-perspective: 1000;-webkit-backface-visibility: hidden;", n = "-webkit-transition: -webkit-transform " + t.config.over + " " + t.config.easing + " 0s, opacity " + t.config.over + " " + t.config.easing + " 0s; transition: transform " + t.config.over + " " + t.config.easing + " 0s, opacity " + t.config.over + " " + t.config.easing + " 0s; -webkit-perspective: 1000; -webkit-backface-visibility: hidden; ", r = function () {
                0 != parseInt(t.config.move) && (i += " translate" + t.config.axis + "(" + t.config.move + ")", s += " translate" + t.config.axis + "(0)"), 0 != parseInt(t.config.scale.power) && ("up" == t.config.scale.direction && (t.config.scale.value = 1 - .01 * parseFloat(t.config.scale.power)), "down" == t.config.scale.direction && (t.config.scale.value = 1 + .01 * parseFloat(t.config.scale.power)), i += " scale(" + t.config.scale.value + ")", s += " scale(1)"), i += "; opacity: " + t.config.opacity + "; ", s += "; opacity: 1; "
            }, i = "transform:", s = "transform:", r(), i += "-webkit-transform:", s += "-webkit-transform:", r(), {
                transition: e,
                initial: i,
                target: s,
                reset: n,
                inline: o,
                duration: 1e3 * (parseFloat(t.config.over) + parseFloat(t.config.wait))
            }
        }, filter: function (t) {
            var e = [], i = ["from", "the", "and", "then", "but", "with", "please"];
            return t.forEach(function (t) {
                i.indexOf(t) > -1 || e.push(t)
            }), e
        }, getViewportH: function () {
            var e = o.config.viewport.clientHeight, i = t.innerHeight;
            return o.config.viewport == t.document.documentElement && i > e ? i : e
        }, scrollY: function () {
            return o.config.viewport == t.document.documentElement ? t.pageYOffset : o.config.viewport.scrollTop + o.config.viewport.offsetTop
            ...
            var i = e.domEl.offsetHeight, s = o.getOffset(e.domEl).top, n = s + i, r = e.config.vFactor || 0;
            return s + i * r < o.scrolled + o.getViewportH() && n - i * r > o.scrolled || "fixed" == (e.domEl.currentStyle ? e.domEl.currentStyle : t.getComputedStyle(e.domEl, null)).position
        }, isMobile: function () {
            ...
            for (var t = document.createElement("sensor"), e = "Webkit,Moz,O,".split(","), i = ("transition " + e.join("transition,")).split(","), s = 0; s < i.length; s++)if ("" === !t.style[i[s]])return !1;
            return !0
        }, destroy: function () {
            var t;
            t = Array.prototype.slice.call(o.config.viewport.querySelectorAll("[data-sr]")), t.forEach(function (t) {
                t.removeAttribute("data-sr")
            })
        }
    }, n = function (t) {
        o.blocked || (o.blocked = !0, o.scrolled = o.scrollY(), i(function () {
            o.animate()
        }))
    }, s = function (t, e) {
    ...
    t(document).ready(function () {
        t(".case-carousel.owl-carousel").owlCarousel({
            autoplay: !0,
...
var ongr_sticky_nav_threshold = .4, ongr_sections = [], ongr_scrolled_top = 0, ongr_window_height = 0;
!function (t) {
    t(document).ready(function () {
        ongr_match_height(), ongr_window_height = t(window).innerHeight(), t("#sticky-pageheader, #pageheader").bind("click", function (t) {
            t.stopPropagation()
        }), t("#sticky-pageheader li[data-section], #pageheader li[data-section], #pagefooter li[data-section]").bind("click", function () {
            var e = t('.ongr-sectionlink[name="' + t(this).attr("data-section") + '"]'), i = t(e).offset().top - t("#sticky-pageheader").height() - 32;
            ongr_scroll(i)
        }), t("#sticky-pageheader .mobile-menu, #pageheader .mobile-menu").bind("click", function (e) {
            e.preventDefault(), t("#sticky-pageheader .mobile-menu, #pageheadeer .mobile-menu").toggleClass("menu-active"), t("#pageheader .mainmenu ul").toggleClass("navigation-active")
        }), t("body").bind("click", function (e) {
            t("#pageheader .mainmenu ul").hasClass("navigation-active") && (t("#sticky-pageheader .mobile-menu, #pageheader .mobile-menu").removeClass("menu-active"), t("#pageheader .mainmenu ul").removeClass("navigation-active"))
        })
    }), t(window).load(function () {
        ongr_scrolled_top = t(window).scrollTop(), ongr_sectiondata(), ongr_nav_highlight(), ongr_sticky_nav(), FastClick.attach(document.body)
    }), t(window).resize(ongr_throttle(function () {
        ongr_scrolled_top = t(window).scrollTop(), ongr_window_height = t(window).innerHeight(), ongr_match_height(), ongr_nav_highlight(), ongr_sectiondata()
    }, 200)), t(window).scroll(ongr_throttle(function () {
        ongr_scrolled_top = t(window).scrollTop(), ongr_nav_highlight(), ongr_sticky_nav()
    }, 250))
}(window.jQuery);